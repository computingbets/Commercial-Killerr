...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  var data = getFormFields(event.target);
	  api.signIn(data).then(ui.signInSuccess).then(ui.signInDisplayVotes).then(api.postVote(data)).then(ui.postVoteSuccess).fail(ui.failure);
	};
	...
	var onChannelInput = function onChannelInput(event) {
	  ...
	  var data = getFormFields(event.target);
	  console.log(data);
	  api.channelInput(data).then(ui.channelInputSuccess).catch(ui.channelInputFailure);
	};
	...
	var onGetChannelAds = function onGetChannelAds(event) {
	  ...
	  api.getChannelAds(channelTargeted).then(api.updateChannelAds).then(ui.updateChannelAdsSuccess).then(onIndexChannels).catch(function (error) {
	    return console.error(error);
	  });
	};

	var onGetChannelProg = function onGetChannelProg(event) {
	  //console.log('get dat channel');
	  event.preventDefault();
	  var channelTargeted = $('.program-button').text();
	  api.getChannelProg(channelTargeted).then(api.updateChannelProg).then(ui.updateChannelProgSuccess).then(onIndexChannels).catch(function (error) {
	    return console.error(error);
	  });
	};

	var onDeleteChannel = function onDeleteChannel() {
	  event.preventDefault();
	  var channelDelete = $('.commercial-button').text();
	  api.deleteChannel(channelDelete).then(ui.deleteChannelSuccess).catch(function (error) {
	    return console.error(error);
	  });
	};

	var onIndexChannels = function onIndexChannels() {
	  console.log('eventsindex');
	  event.preventDefault();
	  api.indexChannels().done(ui.indexSuccess).fail(ui.failure);
	};

	var onUpdateVoteProg = function onUpdateVoteProg(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateVoteProg(data).done(console.log('successVoteVote')).fail(ui.failure);
	};

	var onUpdateVoteAds = function onUpdateVoteAds(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.updateVoteProg(data).done(console.log('successVoteVoteAds')).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getChannelAds = function getChannelAds(channelTargeted) {
	  return new Promise(function (resolve, reject) {
	...
	var getChannelProg = function getChannelProg(channelTargeted) {
	  return new Promise(function (resolve, reject) {
	    //console.log(channelTargeted);
	    return $.ajax({
	      url: app.host + "/channels/" + channelTargeted,
	...
	var updateChannelAds = function updateChannelAds(data) {
	  return new Promise(function (resolve, reject) {
	...
	var updateChannelProg = function updateChannelProg(data) {
	  console.log(data.channel.id);
	  return new Promise(function (resolve, reject) {
	    return $.ajax({
	      url: app.host + "/channels/" + data.channel.id,
	...
	var deleteChannel = function deleteChannel(channelDelete) {
	  return new Promise(function (resolve, reject) {
	    return $.ajax({
	...
	var indexChannels = function indexChannels() {
	  return $.ajax({
	    url: app.host + "/channels",
	    method: 'GET'
	  });
	...
	var postVote = function postVote(data) {
	  return new Promise(function (resolve, reject) {
	    return $.ajax({
	      url: app.host + "/votes",
	      method: 'POST',
	...
	var updateVoteProg = function updateVoteProg(data) {
	...
	var updateVoteAds = function updateVoteAds(data) {
	  console.log(data.channel.id);
	  return new Promise(function (resolve, reject) {
	    return $.ajax({
	...
	module.exports = {
	  ...
	  updateChannelAds: updateChannelAds,
	  updateChannelProg: updateChannelProg,
	  deleteChannel: deleteChannel,
	  indexChannels: indexChannels,
	  updateVoteProg: updateVoteProg,
	  updateVoteAds: updateVoteAds,
	  postVote: postVote
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  host: 'https://commercial-killerr.herokuapp.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var slaughterhouse = __webpack_require__(28);
	...
	var channelInputFailure = function channelInputFailure() {
	  console.log('InputFailure');
	  $('#indicator').html('Channel already created. Click slaughterhouse for index');
	};

	var points = 0;
	var updateChannelAdsSuccess = function updateChannelAdsSuccess() {
	  points += 4;
	...
	var updateChannelProgSuccess = function updateChannelProgSuccess() {
	  $('#indicator').css("background-color", "green");
	};

	var deleteChannelSuccess = function deleteChannelSuccess() {
	  $('.button-body').html("");
	...
	var postVoteSuccess = function postVoteSuccess(data) {
	  console.log(data);
	...
	module.exports = {
	  ...
	  channelInputSuccess: channelInputSuccess,
	  channelInputFailure: channelInputFailure,
	  updateChannelAdsSuccess: updateChannelAdsSuccess,
	  updateChannelProgSuccess: updateChannelProgSuccess,
	  deleteChannelSuccess: deleteChannelSuccess,
	  indexSuccess: indexSuccess,
	  postVoteSuccess: postVoteSuccess
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<button class=\"commercial-button\" active>"
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.channel : stack1)) != null ? stack1.id : stack1), depth0))
	    + "</button>\n<button class=\"program-button\" active>"
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.channel : stack1)) != null ? stack1.id : stack1), depth0))
	    + "</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <li>"
	    ...
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.ads : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + ((stack1 = helpers.unless.call(alias1,((stack1 = blockParams[0][0]) != null ? stack1.ads : stack1),{"name":"unless","hash":{},"fn":container.program(4, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "  </li>\n";
	  ...
	  return "<ul>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.channels : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</ul>\n";
